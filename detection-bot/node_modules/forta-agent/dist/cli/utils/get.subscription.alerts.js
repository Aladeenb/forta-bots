...
function provideGetSubscriptionAlerts(getAlerts) {
    ...
    return function getSubscriptionAlerts(subscriptions, createdSince) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var botIds, alertIds, _i, subscriptions_1, subscription, botId, alertId, subscriptionAlertIds, _b, subscriptionAlertIds_1, alertId_1, subscriptionAlerts, query, response, now;
                ...
                switch (_c.label) {
                    case 0:
                        ...
                        for (_i = 0, subscriptions_1 = subscriptions; _i < subscriptions_1.length; _i++) {
                            ...
                            botId = subscription.botId, alertId = subscription.alertId, subscriptionAlertIds = subscription.alertIds;
                            botIds.add(botId);
                            if (alertId) {
                                alertIds.add(alertId);
                            }
                            if (subscriptionAlertIds) {
                                for (_b = 0, subscriptionAlertIds_1 = subscriptionAlertIds; _b < subscriptionAlertIds_1.length; _b++) {
                                    alertId_1 = subscriptionAlertIds_1[_b];
                                    alertIds.add(alertId_1);
                                }
                            }
                        }
                        subscriptionAlerts = [];
                    ...
                    case 2:
                        response = _c.sent();
                        subscriptionAlerts.push.apply(subscriptionAlerts, response.alerts);
                        _c.label = 3;
                    case 3:
                        if ((_a = response.pageInfo) === null || _a === void 0 ? void 0 : _a.hasNextPage) return [3, 1];
                        _c.label = 4;
                    case 4: return [2, subscriptionAlerts];
                }
            });
        });
    };
